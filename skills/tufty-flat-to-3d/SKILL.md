...
Stand a flat-laid garment up into a worn, three-dimensional shot. Flat to 3D on tufty.ai: turn a flat-lay or hanger photo of a garment into a worn-looking, three-dimensional shot (ghost mannequin style) without a model. Use when the user has flat-lay clothing photos and wants volume, fit and drape for product listings.
...
Execute `tufty flat-to-3d` to get the result.
...
[image] Flat to 3D: Stand a flat-laid garment up into a worn, three-dimensional shot.
...
Options:
  ...
  --model <file|url...>    Model image(s) (the pet, person or subject): local path, data: URL or http(s) URL. Each
                           model is paired with every product. Optional.
